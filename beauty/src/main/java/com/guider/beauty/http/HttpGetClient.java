...
import com.guider.beauty.utils.NetWorkUtils;
import com.guider.beauty.utils.NetWorkUtils.NetWorkState;
...
public class HttpGetClient {
	...
	public void asyHttpGetRequest(String url, com.guider.beauty.http.HttpResponseCallBack httpCallBack) {
		Log.i("zjw","--------url0--------"+url);
	...
	private Runnable getGetHttpThread(final String urlStr,
			final com.guider.beauty.http.HttpResponseCallBack httpCallBack) {
