...
import com.guider.beauty.utils.SystemTools;


public class AboutUsActivity extends BaseActivity {
	private ImageView m_toggle, m_setting;
	private TextView top_bar_title, not_version, not_sinaweibo, src_see, src_address;
	...
	private void initView() {
		...
		not_version.setText("软件版本：" + SystemTools.getAppVersion(this).versionName);
		not_sinaweibo = (TextView) findViewById(R.id.not_sinaweibo);
		not_sinaweibo.setMovementMethod(LinkMovementMethod.getInstance());
		not_sinaweibo
				.setText(Html.fromHtml("<b>新浪微博: </b>" + "<a href=\"http://weibo.com/0099lingyong\">@drawable</a>"));
		// 源码
		...
		src_address.setText(Html.fromHtml("<b>源码地址: </b>"
				+ "<a href=\"https://git.oschina.net/linving/Girst.git\">https://git.oschina.net/linving/Girst.git</a>"));
		...
		src_see.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (c >= 125) {
					...
					Toast.makeText(getApplicationContext(), "请查看125张美女大图,哈哈", Toast.LENGTH_SHORT).show();
				}
			}
		});
